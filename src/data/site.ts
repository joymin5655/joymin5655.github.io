    ...
    items: {
      ...
      posture: {
        ...
        frame: {
          ...
          process: '의견 충돌은 사용자 기준을 문서로 정리해 풀었습니다. 모델은 픽셀 CNN 대신 관절 랜드마크 특징과 XGBoost를 택해 조명·거리에 견고하고 CPU 실시간이 되게 했습니다. 프로젝트 마지막 배포는 인프라 지식 부족으로 실패했고, 2026년에 서버를 다시 올리는 대신 판정을 전부 브라우저(WASM + ONNX)로 옮기는 안을 택했습니다.',
